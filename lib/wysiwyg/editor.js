...
proto.addCommands = function () {
  ...
  function styleSelection(type, editor, arg) {
      var range  = self.editor.getSelectionRange()
        , start  = common.normalizeLocation(range.start)
        , end    = common.normalizeLocation(range.end)
  ...
  self.editor
    .on('change', function (e) {
      var action = e.data.action
        , start  = common.normalizeLocation(e.data.range.start)
        , end    = common.normalizeLocation(e.data.range.end)
      ;
